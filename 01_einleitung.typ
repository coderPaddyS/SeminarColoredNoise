= Einleitung
Als Rauschen werden Signale bezeichnet, deren Verhalten nicht durch einfache Sachverhalte beschrieben werden können und die aufgrund der Komplexität der Erzeugersysteme nicht vorhersehbar sind.
...
Solche Erzeugersysteme haben eine hohe Entropie und damit viele Informationen, im vorherigen Beispiel die Bewegungen, Phasen, ... aller Elementarleiter in einem Leiter.
