...
#let ieee(
  ...
  set par(justify: true, first-line-indent: (amount: 1em), spacing: 0.5em, leading: 0.5em)
  ...
  if abstract != none {
    ...
    [_Zusammenfassung_ ---#h(weak: true, 0pt)#abstract]

    if index-terms != () {
      parbreak()
      [_Stichworte_---#h(weak: true, 0pt)#index-terms.join[, ]]
    }
    v(2pt)
  }
